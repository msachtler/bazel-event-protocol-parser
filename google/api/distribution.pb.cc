...
const ::google::protobuf::uint32 TableStruct::offsets[] = {
  ...
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET((&_Distribution_BucketOptions_default_instance_), linear_buckets_),
  GOOGLE_PROTOBUF_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET((&_Distribution_BucketOptions_default_instance_), exponential_buckets_),
  GOOGLE_PROTOBUF_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET((&_Distribution_BucketOptions_default_instance_), explicit_buckets_),
