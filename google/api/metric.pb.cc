...
class Metric_LabelsEntryDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<Metric::Metric_LabelsEntry> {
...
file_level_metadata[1].reflection = Metric::Metric_LabelsEntry::CreateReflection(file_level_metadata[1].descriptor, _Metric_LabelsEntry_default_instance_.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _Metric_LabelsEntry_default_instance_.DefaultConstruct();
  _Metric_default_instance_.DefaultConstruct();
  _Metric_LabelsEntry_default_instance_.get_mutable()->set_default_instance(_Metric_LabelsEntry_default_instance_.get_mutable());
  _Metric_LabelsEntry_default_instance_.get_mutable()->InitAsDefaultInstance();
}
