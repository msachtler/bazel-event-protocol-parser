...
namespace v1 {
class MetricValue_LabelsEntryDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<MetricValue::MetricValue_LabelsEntry> {
...
const ::google::protobuf::uint32 TableStruct::offsets[] = {
  ...
  GOOGLE_PROTOBUF_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET((&_MetricValue_default_instance_), bool_value_),
  GOOGLE_PROTOBUF_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET((&_MetricValue_default_instance_), int64_value_),
  GOOGLE_PROTOBUF_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET((&_MetricValue_default_instance_), double_value_),
  GOOGLE_PROTOBUF_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET((&_MetricValue_default_instance_), string_value_),
  GOOGLE_PROTOBUF_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET((&_MetricValue_default_instance_), distribution_value_),
...
file_level_metadata[0].reflection = MetricValue::MetricValue_LabelsEntry::CreateReflection(file_level_metadata[0].descriptor, _MetricValue_LabelsEntry_default_instance_.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _MetricValue_LabelsEntry_default_instance_.DefaultConstruct();
  _MetricValue_default_instance_.DefaultConstruct();
  _MetricValueSet_default_instance_.DefaultConstruct();
  _MetricValue_LabelsEntry_default_instance_.get_mutable()->set_default_instance(_MetricValue_LabelsEntry_default_instance_.get_mutable());
  _MetricValue_LabelsEntry_default_instance_.get_mutable()->InitAsDefaultInstance();
...
::google::protobuf::uint8* MetricValueSet::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0, n = this->metric_values_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        2, this->metric_values(i), deterministic, target);
  }
