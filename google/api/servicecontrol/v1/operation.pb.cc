...
namespace v1 {
class Operation_LabelsEntryDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<Operation::Operation_LabelsEntry> {
...
file_level_metadata[0].reflection = Operation::Operation_LabelsEntry::CreateReflection(file_level_metadata[0].descriptor, _Operation_LabelsEntry_default_instance_.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _Operation_LabelsEntry_default_instance_.DefaultConstruct();
  _Operation_default_instance_.DefaultConstruct();
  _Operation_LabelsEntry_default_instance_.get_mutable()->set_default_instance(_Operation_LabelsEntry_default_instance_.get_mutable());
  _Operation_LabelsEntry_default_instance_.get_mutable()->InitAsDefaultInstance();
...
;
  ...
  for (unsigned int i = 0, n = this->metric_value_sets_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        7, this->metric_value_sets(i), deterministic, target);
  }
  ...
  for (unsigned int i = 0, n = this->log_entries_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        8, this->log_entries(i), deterministic, target);
  }
