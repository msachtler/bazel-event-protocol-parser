...
from google.cloud.ml.v1beta1 import prediction_service_pb2 as google_dot_cloud_dot_ml_dot_v1beta1_dot_prediction__service__pb2
...
class OnlinePredictionServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Predict = channel.unary_unary(
        ...
        request_serializer=google_dot_cloud_dot_ml_dot_v1beta1_dot_prediction__service__pb2.PredictRequest.SerializeToString,
...
def add_OnlinePredictionServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'Predict': grpc.unary_unary_rpc_method_handler(
          servicer.Predict,
          request_deserializer=google_dot_cloud_dot_ml_dot_v1beta1_dot_prediction__service__pb2.PredictRequest.FromString,
