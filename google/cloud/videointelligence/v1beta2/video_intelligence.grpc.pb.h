   ...
   public:
    WithStreamedUnaryMethod_AnnotateVideo() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::StreamedUnaryHandler< ::google::cloud::videointelligence::v1beta2::AnnotateVideoRequest, ::google::longrunning::Operation>(std::bind(&WithStreamedUnaryMethod_AnnotateVideo<BaseClass>::StreamedAnnotateVideo, this, std::placeholders::_1, std::placeholders::_2)));
    }
