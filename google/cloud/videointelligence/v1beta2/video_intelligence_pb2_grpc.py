...
from google.cloud.videointelligence.v1beta2 import video_intelligence_pb2 as google_dot_cloud_dot_videointelligence_dot_v1beta2_dot_video__intelligence__pb2
...
class VideoIntelligenceServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.AnnotateVideo = channel.unary_unary(
        ...
        request_serializer=google_dot_cloud_dot_videointelligence_dot_v1beta2_dot_video__intelligence__pb2.AnnotateVideoRequest.SerializeToString,
...
def add_VideoIntelligenceServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'AnnotateVideo': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=google_dot_cloud_dot_videointelligence_dot_v1beta2_dot_video__intelligence__pb2.AnnotateVideoRequest.FromString,
