 ...
 public:
  ...
  class Stub final : public StubInterface {
   ...
   private:
    ...
    const ::grpc::RpcMethod rpcmethod_ListExclusions_;
    const ::grpc::RpcMethod rpcmethod_GetExclusion_;
    const ::grpc::RpcMethod rpcmethod_CreateExclusion_;
    const ::grpc::RpcMethod rpcmethod_UpdateExclusion_;
    const ::grpc::RpcMethod rpcmethod_DeleteExclusion_;
  };
   ...
   public:
    WithStreamedUnaryMethod_ListExclusions() {
      ::grpc::Service::MarkMethodStreamed(5,
        new ::grpc::StreamedUnaryHandler< ::google::logging::v2::ListExclusionsRequest, ::google::logging::v2::ListExclusionsResponse>(std::bind(&WithStreamedUnaryMethod_ListExclusions<BaseClass>::StreamedListExclusions, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_GetExclusion() {
      ::grpc::Service::MarkMethodStreamed(6,
        new ::grpc::StreamedUnaryHandler< ::google::logging::v2::GetExclusionRequest, ::google::logging::v2::LogExclusion>(std::bind(&WithStreamedUnaryMethod_GetExclusion<BaseClass>::StreamedGetExclusion, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_CreateExclusion() {
      ::grpc::Service::MarkMethodStreamed(7,
        new ::grpc::StreamedUnaryHandler< ::google::logging::v2::CreateExclusionRequest, ::google::logging::v2::LogExclusion>(std::bind(&WithStreamedUnaryMethod_CreateExclusion<BaseClass>::StreamedCreateExclusion, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_UpdateExclusion() {
      ::grpc::Service::MarkMethodStreamed(8,
        new ::grpc::StreamedUnaryHandler< ::google::logging::v2::UpdateExclusionRequest, ::google::logging::v2::LogExclusion>(std::bind(&WithStreamedUnaryMethod_UpdateExclusion<BaseClass>::StreamedUpdateExclusion, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_DeleteExclusion() {
      ::grpc::Service::MarkMethodStreamed(9,
        new ::grpc::StreamedUnaryHandler< ::google::logging::v2::DeleteExclusionRequest, ::google::protobuf::Empty>(std::bind(&WithStreamedUnaryMethod_DeleteExclusion<BaseClass>::StreamedDeleteExclusion, this, std::placeholders::_1, std::placeholders::_2)));
    }
