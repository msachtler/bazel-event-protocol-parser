...
const ::google::protobuf::uint32 TableStruct::offsets[] = {
  ...
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET((&_TransferSpec_default_instance_), gcs_data_source_),
  GOOGLE_PROTOBUF_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET((&_TransferSpec_default_instance_), aws_s3_data_source_),
  GOOGLE_PROTOBUF_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET((&_TransferSpec_default_instance_), http_data_source_),
  GOOGLE_PROTOBUF_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET((&_TransferSpec_default_instance_), gcs_data_sink_),
...
::google::protobuf::uint8* ErrorSummary::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0, n = this->error_log_entries_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        3, this->error_log_entries(i), deterministic, target);
  }
...
::google::protobuf::uint8* TransferOperation::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0, n = this->error_breakdowns_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        8, this->error_breakdowns(i), deterministic, target);
  }
