...
from google.watcher.v1 import watch_pb2 as google_dot_watcher_dot_v1_dot_watch__pb2
  ...
  *atomic group*. Systems that support multi-element atomic updates may
  ...
  def __init__(self, channel):
    ...
    self.Watch = channel.unary_stream(
        ...
        request_serializer=google_dot_watcher_dot_v1_dot_watch__pb2.Request.SerializeToString,
        response_deserializer=google_dot_watcher_dot_v1_dot_watch__pb2.ChangeBatch.FromString,
        )
...
def add_WatcherServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'Watch': grpc.unary_stream_rpc_method_handler(
          servicer.Watch,
          request_deserializer=google_dot_watcher_dot_v1_dot_watch__pb2.Request.FromString,
          response_serializer=google_dot_watcher_dot_v1_dot_watch__pb2.ChangeBatch.SerializeToString,
      ),
  }
